...
export const deleteRoom = (id, data) => api.delete(`/api/rooms/${id}`, { data });
...
export const editMessage = (id, data) => api.put(`/api/messages/${id}`, data);
export const unsendMessage = (id, data) => api.patch(`/api/messages/${id}/unsend`, data);
export const clearChat = (roomId) => api.delete(`/api/messages/room/${roomId}`);
